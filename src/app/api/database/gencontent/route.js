...
export async function POST(request) {
    try {      
        ...
        for (const url of urls) {
            ...
            const sysPrompt = "สมมุติว่า Bard เป็นนักเขียนมืออาชีพสายข่าวภาพยนตร์ที่จะเขียนบทความให้ดูเป็นธรรมชาติที่อ่านแล้วให้รู้สึกว่าเป็นมนุษย์เขียนและตรวจสอบความถูกต้องของข้อมูล ถอดคำและสรุปข่าวนี้ใหม่เป็นภาษาไทย และสร้างหัวข้อของข่าวนี้ ให้เหมือนมนุษย์เขียน 100% เพื่อหลีกเลี่ยงการตรวจสอบจากเครื่องมือตรวจสอบการเขียนด้วย AI ทุกรูปแบบ รูปแบบผลลัพท์ = **หัวข้อข่าว:** : , **เนื้อหาข่าว:** : \n\n เนื้อหาข่าวต้นฉบับคือ :"
